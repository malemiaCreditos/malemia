          ...
          <>
            <div className="flex flex-row gap-4">
                  ...
                  <CardBody>
                    <div className="flex flex-row gap-2">
                      ...
                      <div className="flex flex-col">
                        <p className="text-lg font-bold">TOTAL INVESTIDO</p>
                ...
                <Card>
                  <CardBody>
                    <div className="flex flex-row gap-2">
                      ...
                      <div className="flex flex-col">
                        <p className="text-lg font-bold">REC. PRINCIPAL</p>
                        <p className="text-lg text-default-500">
                          {Intl.NumberFormat("de-DE", {
                            style: "currency",
                            currency: "MZN",
                ...
                <Card>
                  <CardBody>
                    <div className="flex flex-row gap-2">
                      ...
                      <div className="flex flex-col">
                        <p className="text-lg font-bold">REC. JUROS</p>
                        <p className="text-lg text-default-500">
                          {Intl.NumberFormat("de-DE", {
                            style: "currency",
                            currency: "MZN",
                ...
                <Card>
                  <CardBody>
                    <div className="flex flex-row gap-2">
                      ...
                      <div className="flex flex-col">
                        <p className="text-lg font-bold">PROV. JUROS</p>
                        <p className="text-lg text-default-500">
                          {Intl.NumberFormat("de-DE", {
                            style: "currency",
                            currency: "MZN",
                ...
                <Card>
                  <CardBody>
                    <div className="flex flex-row gap-2">
                      ...
                      <div className="flex flex-col">
                        <p className="text-lg font-bold">ATRASADO</p>
                        <p className="text-lg text-default-500">
                          {Intl.NumberFormat("de-DE", {
                            style: "currency",
                            currency: "MZN",
                ...
                <Card>
                  <CardBody>
                    <div className="flex flex-row gap-2">
                      ...
                      <div className="flex flex-col">
                        <p className="text-lg font-bold">TOTAL A RECEBER</p>
                        <p className="text-lg text-default-500">
                          {Intl.NumberFormat("de-DE", {
                            style: "currency",
                            currency: "MZN",
              ...
              <div className="w-[150px]">
                <div className="bg-yellow-900 p-1 text-center">
                  <button
                    type={"button"}
